...
* **Storage Providers**: Local Folders / Mounted Drives, Google Drive (appFolder), OneDrive, and peer to peer.
  * Local Folders and Google Drive on Desktop implemented so far.
